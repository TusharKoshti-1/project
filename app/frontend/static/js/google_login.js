  ...
  document.getElementById('googleLoginButton').addEventListener('click', function() {
    ...
    window.location.href = '/googlelogin';  // This triggers the OAuth flow from FastAPI
  });
  
  // Function to handle login via Google
  // async function handleGoogleLogin() {
  //   console.log('Handle Google Login function called');
  //   const googleLoginUrl = "https://exact-notable-tadpole.ngrok-free.app/googlelogin"; // Replace with your actual login URL
